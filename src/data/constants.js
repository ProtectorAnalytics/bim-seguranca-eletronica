...
export const APP_VERSION = {
  major: 3, minor: 19, build: 0,
  date: '2026-03-09',
  get full(){ return `v${this.major}.${this.minor}.${this.build}`; },
  get label(){ return `v${this.major}.${this.minor} build ${this.build}`; },
  changelog: [
    {ver:'3.19.0',date:'2026-03-09',changes:['Refatoração do catálogo: 13 famílias removidas (MHD, DVR, HDCVI, Veicular, Alarme, PIR, Eletrificadores, Periféricos, S8000, Incêndio Conv/End/Especiais, Morley, Iluminação Emergência)','Dispositivos unificados por forma: variantes de resolução consolidadas em key único (ex: cam_ip_bullet_2mp/3mp/4mp → cam_ip_bullet)','Catálogo reduzido: ~160 → ~60 dispositivos genéricos em 9 famílias','Fabricante genérico: todas referências a fabricantes removidas, todos dispositivos com manufacturer:Genérico','Migração automática de projetos legados: keys antigos convertidos para novos unificados ao abrir projeto','Dispositivos de famílias deletadas marcados como legado (⚠️) em projetos existentes','Novas categorias no repositório de equipamentos: Wi-Fi e Automatizadores','Schemas de specs: novos schemas para Automatizador e Wi-Fi','PDF Export: categorização simplificada sem famílias deletadas','Regras de validação: removidas regras de incêndio e intrusão (famílias deletadas)']},
