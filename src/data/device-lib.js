...
export const DEVICE_LIB = [
  ...
  {cat:'Infraestrutura',color:'#6b7280',items:[
    {key:'quadro',name:'Quadro Conectividade',icon:'quadro',poe:false,ports:1,isContainer:true,configurable:true,configFields:['vagas'],manufacturer:'Genérico',props:{material:'PVC IP65',trilho:'DIN',vagas:'12-36 módulos'}},
    ...
    {key:'bateria_ext',name:'Bateria Externa',icon:'bateria_ext',poe:false,ports:1,configurable:true,configFields:['tensao','capacidade','modelo'],manufacturer:'Genérico',props:{tensao:'12V',tipo:'Estacionária VRLA'},ref:''},
    ...
    {key:'fonte',name:'Fonte 12V',icon:'fonte',poe:false,ports:1,manufacturer:'Genérico',props:{corrente:'10A',entrada:'90-240Vac'},ref:''},
